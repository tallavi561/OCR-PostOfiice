...
namespace CameraAnalyzer.bl.Services.PackagesAnalysis.MiddleServices
{
    ...
    {
        public List<string> GetCroppetImages(string originalImage, List<BoundingBox> boxes)
        {
            ...
            foreach (var box in boxes)
            {
                ...
                ImagesProcessing.CropAndSaveImage(box.X1, box.Y1, box.X2, box.Y2, originalImage, newFile, true);
                cropped.Add(newFile);
            }
